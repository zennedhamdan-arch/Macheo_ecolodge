      ...
      <section className="admin-card">
        ...
        {active?.video_url ? (
          ...
          <p className="admin-muted">
            Nothing is live. The homepage is showing the built-in Lake Kivu photograph.
          </p>
        )}
        ...
        <label className="admin-check">
          ...
          <span>
            ...
            <small className="admin-hint">
              Turn this off to fall back to the hero image without deleting
              anything.
            </small>
          </span>
        </label>
      ...
      <div className="admin-list-body">
        ...
        <label className="admin-field">
          ...
          <input
            className="admin-input"
            value={subtitle}
            placeholder="Stay closer to nature. Experience Lake Kivu."
