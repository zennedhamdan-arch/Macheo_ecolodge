...
const EXPERIENCE_CATEGORIES = ["Lake", "Nature", "Adventure", "Local"] as const;
    ...
    <div className="admin-stack">
      ...
      {rows.length === 0 ? (
        <p className="admin-muted">
          No experiences yet — the public Experiences page shows an honest
          empty state until the first one is added here.
        </p>
      ) : (
