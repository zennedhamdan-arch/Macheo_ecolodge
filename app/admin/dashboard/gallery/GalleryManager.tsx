...
const GALLERY_CATEGORIES = ["Stay", "Camping", "Restaurant & Bar", "Experiences", "Lake Kivu", "Nature"] as const;
          ...
          <div className="admin-row">
            ...
            <label className="admin-field">
              ...
              <select
                ...
                value={row.category ?? ""}
                disabled={busy}
                onChange={(e) => void onSave(row.id, { category: (e.target.value || null) as GalleryCategory | null })}
              >
                <option value="">—</option>
